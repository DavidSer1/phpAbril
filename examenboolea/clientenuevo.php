...
if(nuevocliente($dni, $nombre, $direccion, $localidad, $provincia, $telefono, $email, $password)){
...
?>
  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
    ...
    <div>
      ...
      <input type="text" id="localidad" name="localidad" maxlength="30" >
    </div>
    ...
    <div>
      ...
      <input type="email" id="email" name="email" maxlength="30" value="pepe@pepe.com">
    </div>
<div>
